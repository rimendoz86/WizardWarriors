...
func seedDatabase(ctx context.Context, pool *pgxpool.Pool) error {
	...
	_, err = tx.Exec(ctx, `
		...
		VALUES
			(1, 2, 2, 20, 436, 25, 10, 40, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(2, 3, 3, 15, 300, 20, 8, 30, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(3, 4, 4, 10, 105, 15, 6, 20, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, TRUE),
			(4, 1, 1, 25, 250, 10, 20, 50, TRUE, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, FALSE);
	`)
	if err != nil {
